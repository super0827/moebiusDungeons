      ...
      return {
            ...
            characterClasses: [
...

              {
                ...
                special: "variagate",
                specialDescription:"Spend one mettle to deal 5 damage to the enemy that ignores armor. The monster won’t attack you back when you use Variagate.",
...

              {
                ...
                special: "Backstab",
                specialDescription:"Spend 1 Mettle to deal your maximum damage to the monster. The monster won’t attack you back when you use Backstab.",
